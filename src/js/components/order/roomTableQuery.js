...
class RoomTableQuery extends Component {
  ...
  render() {
    return (
      <form onSubmit={this.onQeuryClick.bind(this)}>
        <div className="row">
          ...
          <ButtonInput type="submit" bsStyle="primary" groupClassName="col-sm-6 col-md-4" value="查找" block onclick={this.onQeuryClick.bind(this)}/>
        </div>
      </form>
    );
  }
